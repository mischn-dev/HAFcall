...
the `readDict` function can also only read files that do have a specific character of interest in their name - e.g. `readDict("C:/Users/me/Desktop/folder", "F")` to read files that do have acapital F in its name
